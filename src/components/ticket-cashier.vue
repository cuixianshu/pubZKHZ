  ...
  <div class="father">
    ...
    <div class="container-fluid">
      <div class="row form-inline query">
        <input id="queryConditions" type="text" class="form-control" v-model="queryContent.keyWord" placeholder="请输入搜索关键词" title="票号、乘机人、客户单位等搜索关键词">
    ...
    <div v-if="listOfTickets.length>0" class="divfortable">
        ...
        <div class="modal-content">  
          ...
          <div class="modal-body">
            <div id="detailsForCashier" class="container-fluid">
              ...
              <div class="row">
                <div class="col-lg  form-inline">
                  <label for="iptAII">票价税险</label>
                  <input id="iptAII" type="number" class="form-control" v-model="cashier.amountIncludeInsurance" placeholder="收取的票价、税、保险之和" title="收取的票价、税、保险之和">
                </div>
                <div class="col-lg  form-inline">
                  <label for="inputRefoundFee">收退票费</label>
                  <input id="inputRefoundFee" type="number" class="form-control" v-model="cashier.refoundFee" placeholder="收取的退票手续费金额" title="收取的退票手续费金额">
                </div>
              </div>
              <div class="row">
                <div class="col-lg  form-inline">
                  <label for="inputChangeFee">收改签费</label>
                  <input id="inputChangeFee" type="number" class="form-control" v-model="cashier.changeFee" placeholder="改签费用" title="收取的改签费用金额">
                </div>
                <div class="col-lg  form-inline">
                  <label for="inputOther">备注信息</label>
                  <input id="inputOther" type="text" class="form-control" v-model="cashier.other" title="备注信息,不超过64个字" placeholder="备注信息,不超过64个字">
                </div>
              </div>
            </div>
          </div>
          <div class="modal-footer">  
            ...
            <button id="btnSaveTheCollectedData" @click="saveTheCollectedData" class="btn btn-primary">确定</button>
          </div>           
        </div>
      </div>
    </div>    
...
// console.log(response.data);
      ...
      clickedARowInShower(dataRow) {
        ...
        this.cashier.other='';
        this.cashier.abstract='票号:'+dataRow.number_ticket+',收票款:'+this.cashier.amountIncludeInsurance+',收退票费:'+this.cashier.refoundFee+',收改签费人:'+this.cashier.changeFee;
