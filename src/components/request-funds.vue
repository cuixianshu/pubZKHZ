      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">  
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-lg  form-inline">
                  ...
                  <select id="slctProject" type="text" name="Project" class="form-control" placeholder="所属项目" v-model="requestFunds.project" title="所属项目">
                    <option v-for="item in projects">{{item.prjct}}</option>}
                  </select>
                </div>
                <div class="col-lg  form-inline">
                  <label for="inputUsage">用途</label>
                  <input id="inputUsage" type="text" class="form-control" v-model="requestFunds.use_for" title="款项用途,不超过64个字" placeholder="款项用途,不超过64个字">
                </div>
              </div>
              <div class="row">
                <div class="col-lg  form-inline">
                  <label for="inputCashiedAmount">金额</label>
                  <input id="inputCashiedAmount" type="number" class="form-control" name="cashiedAmount" v-model="requestFunds.amount" placeholder="请款金额" title="请款金额">
                </div>
                <div class="col-lg  form-inline">
                  <label for="slctWayOfCashier">方式</label>
                  <select id="slctWayOfCashier" type="text" class="form-control" name="wayOfCashier" v-model="requestFunds.way" placeholder="收款方式" title="收款方式">
              ...
              <div class="row">
                <div class="col-lg  form-inline">
                  ...
                  <input id="slctCashierAccount" type="text" name="cashierAccount" class="form-control" placeholder="接收款项的账号" v-model="requestFunds.account" title="账号名和账号">
                </div>
                <div class="col-lg  form-inline">
                  <label for="inputRemark">备注</label>
                  <input id="inputRemark" type="text" class="form-control" name="otherInCashier" v-model="requestFunds.remark" title="备注信息,不超过64个字" placeholder="备注信息,不超过64个字">
                </div>
              </div>
              <div class="row" v-if="requestFunds.result_approved==0">
          ...
          <div class="modal-footer">  
            ...
            <button type="button" id="btnSaveTheRequestedData" @click="saveTheRequestedData" class="btn btn-primary">提交</button>
          </div>           
        </div>
      </div>
    </div>    
...
// console.log(response.data);
      ...
      newCreateRequestFunds() {
        ...
        this.requestFunds.result_approved='new create';
        $('#mdlRequestFunds').modal('toggle');
      }
    },
    watch:{
